...
def ver_historial():
    ...
    print("  " +
          ...
          " ".rjust(4) +
          " ".rjust(6) +
          "    50cm  60cm  70-80-90cm" +
          "     Rojo  Rosado  Blanco  Amarillo" +
          "        A    B")
    print(SEP)
    ...
    while p < len(indices):
        ...
        if viveros_c[i] == VIV1:
            ...
            v = "V2"
        print("  " + fechas_c[i].ljust(12) + v.ljust(4) +
              str(bonches_c[i]).rjust(4)   + str(rosas_c[i]).rjust(6) +
              str(m50_c[i]).rjust(7)       + str(m60_c[i]).rjust(5)   + str(m70_c[i]).rjust(4) +
              str(rojo_c[i]).rjust(6)      + str(rosado_c[i]).rjust(5) +
              str(blanco_c[i]).rjust(5)    + str(amarillo_c[i]).rjust(5) +
              str(cal_a_c[i]).rjust(6)     + str(cal_b_c[i]).rjust(5))
    ...
    print(SEP)
    print("  " + "TOTALES".ljust(16) +
          str(t_bon).rjust(4) + str(t_ros).rjust(6) +
          str(t_50).rjust(7)  + str(t_60).rjust(5)  + str(t_70).rjust(4) +
          str(t_rj).rjust(6)  + str(t_rs).rjust(5)  +
          str(t_bl).rjust(5)  + str(t_am).rjust(5)  +
          str(t_a).rjust(6)   + str(t_b).rjust(5))
    print(SEP)
